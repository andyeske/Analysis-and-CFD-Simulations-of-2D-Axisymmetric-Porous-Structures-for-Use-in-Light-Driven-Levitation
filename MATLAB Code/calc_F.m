...
% A_solid: total surface area of the 3D structure. In other words, all of
% the area that is not occupied by the channels
% (units of m2)
% ----------------------------------------------------------------------- %
...
net_lift = fit - 9.8*((A_solid-A_in)*0.001 + vol_walls*den_alumina);
% ----------------------------------------------------------------------- %
